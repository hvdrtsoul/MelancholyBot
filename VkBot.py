...
VK_API_TOKEN = '090cd1aa70d607358365d3b856f463e0fa7348fe54d58ad5315ca6d41f7c8dc5f89d846f1007faecab9a3'
        ...
        if message.upper() == "НАЧАТЬ" or message.upper() == "ПРИВЕТ" or message.upper() == "/HELP":
            ...
            vk.messages.send(
                ...
                message=f"добро пожаловать {self._USERNAME.lower()}!\n" + "список команд и описание работы бота:\n" \
                        + "---\n" \
                        + "<ИМЯ_ГРУППЫ> - запомнить вашу группу\n" \
                        + "---\n" \
                        + "бот - показать расписание для вашей группы\n" \
                        + "---\n" \
...
def get_schedule_files():
    ...
    links = re.findall(r"https.+21-22_весна_очка.xlsx", str(schedule_result)) # fixed to show only lessons schedule
